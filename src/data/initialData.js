...
export const presetBanners = [
  ...
  { id: 'b5', name: 'Bebidas, Licores & Snacks', url: 'https://images.unsplash.com/photo-1597290282695-edc43d0e7129?w=1200&auto=format&fit=crop&q=80' }
];
...
// Directorio de Minimarkets registrados en la plataforma (Red de 43 tiendas)
export { initialStores } from './storesData';
