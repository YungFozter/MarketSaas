...
const MASTER_PRODUCTS = {
  ...
  empanadasSantaClara: {
    ...
    costPrice: 8.50,
    unit: 'Porción x2',
    image: '/products/empanadas-santa-clara-2u.png',
  ...
  redBull250: {
    baseName: 'Energizante Red Bull 250 ml',
    category: 'Bebidas & Refrescos',
    basePrice: 17.00,
    costPrice: 13.00,
    unit: 'Lata 250ml',
  ...
  atunVanCamps: {
    baseName: 'Lomitos de atún en aceite Van Camp’s x 1730 GR',
    category: 'Despensa & Abarrotes',
    basePrice: 12.50,
    costPrice: 9.80,
    unit: 'Lata 1730g',
    image: '/products/atun-van-camps-1730g.png',
    description: 'Lomitos selectos de atún en aceite vegetal Van Camp’s abrefácil x 1730 GR.',
  ...
  mantequillaRegia: {
    baseName: 'Mantequilla con Sal Pil 200 G',
    category: 'Lácteos & Huevos',
    basePrice: 14.50,
    costPrice: 11.50,
    unit: 'Barra 200g',
