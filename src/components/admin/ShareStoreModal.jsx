...
export const ShareStoreModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in">
      <div 
        className="relative w-full max-w-lg bg-white border border-slate-200/90 rounded-3xl shadow-2xl overflow-hidden p-6 sm:p-7 text-slate-900 animate-scale-up max-h-[92vh] flex flex-col"
        role="dialog"
        aria-modal="true"
      >
        {/* Botón Cerrar */}
        ...
        <div className="overflow-y-auto space-y-4 pr-1 flex-1">
          ...
          <button
            ...
            className="w-full p-3.5 rounded-2xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-sm flex items-center justify-center gap-2.5 shadow-md shadow-emerald-600/25 transition-all cursor-pointer active:scale-98"
          >
          ...
          <div className="rounded-2xl border border-slate-200/90 bg-slate-50/70 p-4 relative space-y-3">
            ...
            <div className="text-xs text-slate-700 space-y-2 font-sans bg-white p-3.5 rounded-xl border border-slate-200/80 shadow-2xs">
              ...
              <div className="flex items-start gap-2 pt-1 border-t border-slate-100">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer" 
                    className="text-emerald-600 hover:underline truncate block text-[11px] font-mono font-medium"
                  >
                    {storeUrl}
                  </a>
                </div>
              ...
              <div className="flex items-start gap-2 pt-1 border-t border-slate-100">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <span className="text-slate-600 block text-[11px]">{addressText}</span>
                </div>
              </div>
              ...
              <div className="pt-2 text-center text-emerald-800 font-extrabold text-xs">
                ✨ ¡Te esperamos! ✨
              </div>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              ...
              <button
                ...
                className="p-2.5 rounded-xl border border-slate-200 hover:border-emerald-500 hover:bg-emerald-50/40 transition-all flex flex-col items-center justify-center gap-1 text-center cursor-pointer group"
              ...
              <button
                ...
                className="p-2.5 rounded-xl border border-slate-200 hover:border-blue-500 hover:bg-blue-50/40 transition-all flex flex-col items-center justify-center gap-1 text-center cursor-pointer group"
              ...
              <button
                type="button"
                onClick={handleCopyFullMessage}
                className="p-2.5 rounded-xl border border-slate-200 hover:border-slate-400 hover:bg-slate-100 transition-all flex flex-col items-center justify-center gap-1 text-center cursor-pointer group"
        ...
        {/* Pie de modal */}
        <div className="flex items-center justify-between pt-4 mt-3 border-t border-slate-100 text-xs text-slate-400 shrink-0">
