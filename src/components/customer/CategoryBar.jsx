        ...
        {categories.map((cat) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2.5 px-4 py-2.5 rounded-2xl font-bold text-xs sm:text-sm whitespace-nowrap transition-all duration-200 shrink-0 border ${
                isSelected
